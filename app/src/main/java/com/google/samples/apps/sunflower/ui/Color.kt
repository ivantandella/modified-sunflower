...
val md_theme_light_primary = Color(0xFF1450A3)
val md_theme_light_onPrimary = Color(0xFFFFFFFF)
val md_theme_light_primaryContainer = Color(0xFF80D1F7)
val md_theme_light_onPrimaryContainer = Color(0xFF062100)
val md_theme_light_secondary = Color(0xFF4C5A62)
val md_theme_light_onSecondary = Color(0xFFFFFFFF)
val md_theme_light_secondaryContainer = Color(0xFFCBDFE7)
val md_theme_light_onSecondaryContainer = Color(0xFF131F0D)
val md_theme_light_tertiary = Color(0xFF385867)
...
val md_theme_light_inversePrimary = Color(0xFF67C3DA)
val md_theme_light_shadow = Color(0xFF000000)
val md_theme_light_surfaceTint = Color(0xFF00546D)
val md_theme_light_outlineVariant = Color(0xFFC3C8BB)
val md_theme_light_scrim = Color(0xFF000000)

val md_theme_dark_primary = Color(0xFF1450A3)
val md_theme_dark_onPrimary = Color(0xFF003239)
val md_theme_dark_primaryContainer = Color(0xFF003852)
val md_theme_dark_onPrimaryContainer = Color(0xFF80DFF7)
val md_theme_dark_secondary = Color(0xFFB0CACB)
val md_theme_dark_onSecondary = Color(0xFF213034)
...
val md_theme_dark_inversePrimary = Color(0xFF00646D)
val md_theme_dark_shadow = Color(0xFF000000)
val md_theme_dark_surfaceTint = Color(0xFF67B9DA)
val md_theme_dark_outlineVariant = Color(0xFF43483E)
val md_theme_dark_scrim = Color(0xFF000000)

val seed = Color(0xFF00666F)
